...
func newMessage(db *gorm.DB, opts ...gen.DOOption) message {
	...
	_message.messageDo.UseModel(&dbmodels.Message{})
...
type IMessageDo interface {
	...
	Unscoped() IMessageDo
	Create(values ...*dbmodels.Message) error
	CreateInBatches(values []*dbmodels.Message, batchSize int) error
	Save(values ...*dbmodels.Message) error
	First() (*dbmodels.Message, error)
	Take() (*dbmodels.Message, error)
	Last() (*dbmodels.Message, error)
	Find() ([]*dbmodels.Message, error)
	FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dbmodels.Message, err error)
	FindInBatches(result *[]*dbmodels.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error
	Pluck(column field.Expr, dest interface{}) error
	Delete(...*dbmodels.Message) (info gen.ResultInfo, err error)
	...
	FirstOrInit() (*dbmodels.Message, error)
	FirstOrCreate() (*dbmodels.Message, error)
	FindByPage(offset int, limit int) (result []*dbmodels.Message, count int64, err error)
...
func (m messageDo) Create(values ...*dbmodels.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) CreateInBatches(values []*dbmodels.Message, batchSize int) error {
	return m.DO.CreateInBatches(values, batchSize)
}

// Save : !!! underlying implementation is different with GORM
// The method is equivalent to executing the statement: db.Clauses(clause.OnConflict{UpdateAll: true}).Create(values)
func (m messageDo) Save(values ...*dbmodels.Message) error {
	if len(values) == 0 {
		return nil
	}
...
func (m messageDo) First() (*dbmodels.Message, error) {
	if result, err := m.DO.First(); err != nil {
		return nil, err
	} else {
		return result.(*dbmodels.Message), nil
	}
}

func (m messageDo) Take() (*dbmodels.Message, error) {
...
func (m messageDo) Last() (*dbmodels.Message, error) {
...
func (m messageDo) Find() ([]*dbmodels.Message, error) {
	result, err := m.DO.Find()
	return result.([]*dbmodels.Message), err
}

func (m messageDo) FindInBatch(batchSize int, fc func(tx gen.Dao, batch int) error) (results []*dbmodels.Message, err error) {
	buf := make([]*dbmodels.Message, 0, batchSize)
...
func (m messageDo) FindInBatches(result *[]*dbmodels.Message, batchSize int, fc func(tx gen.Dao, batch int) error) error {
...
func (m messageDo) FirstOrInit() (*dbmodels.Message, error) {
...
func (m messageDo) FirstOrCreate() (*dbmodels.Message, error) {
...
func (m messageDo) FindByPage(offset int, limit int) (result []*dbmodels.Message, count int64, err error) {
...
func (m messageDo) Delete(models ...*dbmodels.Message) (result gen.ResultInfo, err error) {
