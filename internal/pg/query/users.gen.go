...
func newUser(db *gorm.DB, opts ...gen.DOOption) user {
	...
	_user.DateUpdated = field.NewTime(tableName, "date_updated")
	_user.ProfilePic = field.NewString(tableName, "profile_pic")
...
func (u *user) updateTableName(table string) *user {
	...
	u.DateUpdated = field.NewTime(table, "date_updated")
	u.ProfilePic = field.NewString(table, "profile_pic")
...
func (u *user) fillFieldMap() {
	...
	u.fieldMap["date_updated"] = u.DateUpdated
	u.fieldMap["profile_pic"] = u.ProfilePic
